          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>İş birlikçi İşlemleri<small>
                      <?php
                   ...
                   <form action='../netting/islem.php' method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="file" id="first-name" required="required"name="isbirlikci_resimyol" class="form-control ">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="first-name" required="required"name="isbirlikci_ad" placeholder="İş birlikci adını giriniz..." class="form-control ">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                     ...
                     <!--<div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="first-name" required="required"name="isbirlikci_resimyol" placeholder="İş birlikci sıra giriniz..." value="0" class="form-control ">
                      </div>
                    </div>-->
                    ...
                    <div align="right" class="col-md-6 col-sm-6 offset-md-3">
                        <button class="btn btn-primary" name="isbirlikcikaydet" type="submit">Kaydet</button>
