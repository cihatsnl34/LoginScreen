...
<html lang="en">
  <head>
    ...
    <title>Doğa Kuruyemiş Yönetim Paneli</title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="../netting/islem.php" method="POST">
              ...
              <div>
                <button style=" border:0.5px solid ;width: 100%;background-color:#73879C; color: white; "  name="loggin" type="submit" class="btn btn-default">Giriş Yap</button>
              ...
              <div class="separator">
                ...
                <div>
                  <h1>Doga Kuruyemiş</h1>
                  <p>©2021 Doğa Kuruyemiş</p>
                </div>
              </div>
            </form>
          </section>
