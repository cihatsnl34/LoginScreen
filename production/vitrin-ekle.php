                   ...
                   <form action='../netting/islem.php' method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="file" id="first-name" required="required"name="vitrin_resimyol" class="form-control ">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="first-name" required="required"name="vitrin_ad" placeholder="Vitrin adını giriniz..." class="form-control ">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="first-name" name="vitrin_link" placeholder="Vitrin link giriniz..." class="form-control ">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="first-name" required="required"name="vitrin_sira" placeholder="Vitrin sıra giriniz..." value="0" class="form-control ">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                     ...
                     <!--<div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="first-name" required="required"name="vitrin_resimyol" placeholder="Vitrin sıra giriniz..." value="0" class="form-control ">
                      </div>
                    </div>-->
                    ...
                    <div align="right" class="col-md-6 col-sm-6 offset-md-3">
                        <button class="btn btn-primary" name="vitrinkaydet" type="submit">Kaydet</button>
